            ...
            {navItems.map((item) => {
              ...
              return (
                <li key={item.label}>
                  <Link
                    href={item.href}
                    className={`flex items-center gap-3 px-4 py-2 rounded-md text-textDark dark:text-textLight hover-primary
        ...
        <div className="mt-auto border-t border-neutral-200 dark:border-neutral-800 p-4">
          ...
          >
            ...
            <button
              ...
              className={`p-2 rounded hover:bg-error/20 hover:text-error transition-colors duration-200 ${
                !isOpen && "mt-2"
              }`}
              title="Sign out"
            >
