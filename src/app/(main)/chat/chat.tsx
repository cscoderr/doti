...
// import { createSCWSigner } from "@/lib/agent";
...
//   const { conversation, isConversationPending } = useConversation();
...
//   }, [members, address]);
//   const { initializing, initialize } = useXMTP();
...
//     console.log("is connected2", walletData);
...
//         "93a5f3e03d48ac08fa7afaa41c6618a4a0eb7bbe62f80e7c7055ac51398b4ef5"
//       ),
//       env: "dev",
//       loggingLevel: "off",
//       signer,
...
//   useEffect(() => {
//     const dummyMessages: Message[] = Array.from({ length: 10 }, (_, index) => ({
//       id: `msg-${index}`,
