                      ...
                      {(() => {
                          ...
                          return (
                            <button
                              onClick={() => {
                                ...
                                return connect({ connector: connectors[2] });
                                // openConnectModal;
                              }}
                        ...
                        if (chain.unsupported) {
                          return (
                            <button
                              ...
                              className="w-full bg-error text-textLight py-3 px-6 rounded-xl font-semibold hover:bg-opacity-90 transition-colors duration-200"
                            >
                        ...
                        return (
                          <div className="flex flex-col space-y-4">
                            <button
                              onClick={openChainModal}
                              className="w-full bg-secondary/10 text-foreground py-3 px-6 rounded-xl font-semibold hover:bg-secondary/20 transition-colors duration-200 flex items-center justify-center space-x-2"
                            >
                              {chain.hasIcon && (
                                <div
                                  style={{
                            ...
                            <button
                              ...
                              className="w-full bg-secondary/10 text-foreground py-3 px-6 rounded-xl font-semibold hover:bg-secondary/20 transition-colors duration-200"
                            >
                              {account.displayName}
                            </button>
                          </div>
